...
sh_languages['myna'] = [
  [
    ...
    [
      /<%=|<%|%>|@loop|<\/@loop>|@if|<\/@if>|@elseif|@else|@set/g,
      'sh_preproc',
      -1
    ],
    [
    ...
    [
      /<@loop?[A-Za-z][A-Za-z0-9]*/g,
      'sh_preproc',
      4,
      1
    ],
    [
      /\b(?:abstract|break|case|catch|class|const|continue|debugger|default|delete|do|else|enum|export|extends|false|final|finally|for|function|goto|if|implements|index|in|instanceof|interface|native|new|null|private|protected|prototype|public|return|static|super|switch|synchronized|throw|throws|this|transient|true|try|typeof|var|volatile|while|with|array|element)\b/g,
      'sh_keyword',
      -1
    ],
    [
    ...
    [
      /\b(?:Myna|ObjectLib)\b/g,
      'sh_predef_var',
      -1
    ],
    [
      /(\$res|\$server|\$server_gateway|\$req|\$application|\$cookie|\$session)/g,
      ['sh_predef_var'],
      -1
    ]
  ],
