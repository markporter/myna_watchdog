...
/**
 * Flag for a Myna Applicaiotn server.
 * @type Boolean
 * The member is true if the script runs the Myna Application Server.
 */
JsUtil.prototype.isMyna = this.$server_gateway != null;
